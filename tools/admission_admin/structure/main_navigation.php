					<div class="sidebar-category sidebar-category-visible">
						<div class="category-title h6">
							<span>นำทางหลัก (Main navigation)</span>
							<ul class="icons-list">
						...
						<div class="category-content sidebar-user">
							<div class="media">
								<a href="#" class="media-left"><img src="<?php echo base_url();?>tools/Bootstrap 3/Template/global_assets/images/placeholders/placeholder.jpg" class="img-circle img-sm" alt=""></a>
								<div class="media-body">
									<span class="media-heading text-semibold"><?php echo $myname;?></span>
