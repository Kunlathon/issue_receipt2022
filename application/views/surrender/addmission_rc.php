...
<!--++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->	
												<?php
													exit("<script>window.location='http://rc.regina.ac.th/Application/new_admission/admission/print_admission/$user_login/$user_level/$user_plan';</script>");
												?>							
<!--++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->								
						<?php	break;
								case "11": ?>
						...
						<div class="row">
							<center><div class="col-<?php echo $grid;?>-12">
								<div class="panel panel-default">
									<form name="admission_rc" method="GET" action="http://rc.regina.ac.th/Application/new_admission/admission/print_admission/<?php echo $user_login;?>/<?php echo $user_level;?>/<?php echo $user_plan;?>" >
