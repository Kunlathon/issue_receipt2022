...
<body onload="loadFMstatus()" class="col-<?php echo $grid;?>-12">
...
<div class="row">
	<div class="col-<?php echo $grid;?>-12">
		<div class="alert alert-warning">
		  <strong><center><a href="<?php echo base_url();?>surrender/addmission_rc/<?php echo $user_login;?>/<?php echo $regina_stu_datarow["IDCard"];?>/<?php echo $regina_stu_datarow["stu_level"];?>/<?php echo $regina_stu_datarow["stu_plan"];?>">คลิกที่นี่</a></strong> เพื่อดำเนินการมอบตัว...</center>
		</div>
	</div>
</div>	
