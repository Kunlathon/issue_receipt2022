...
<head>
	...
	<title>มอบตัวนักเรียนใหม่&nbsp;ระดับชั้น&nbsp;มัธยมศึกษาปีที่&nbsp;1&nbsp;และ&nbsp;มัธยมศึกษาปีที่&nbsp;4</title>
		...
		<div class="page-content">		
			<div class="row">
				<div class="col-<?php echo $grid;?>-12">
					<img src="<?php echo base_url();?>/tools/img/641106-002.jpg" alt="Cinque Terre" usemap="#Map" class="img-thumbnail" style="width: 100%;" >
				</div>
			</div>
