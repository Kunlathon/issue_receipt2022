...
<head>
	...
	<title>ประกาศผลการสอบ&nbsp;ห้องเรียน&nbsp;วิทยาศาสตร์&nbsp;สสวท.</title>
		...
		<div class="page-content">		
			<div class="row">
				<div class="col-<?php echo $grid;?>-12">
					<img src="<?php echo base_url();?>/tools/img/64-01-918.jpg" alt="Cinque Terre" usemap="#Map" class="img-thumbnail" style="width: 100%;" >
				</div>
			</div>
			<div class="row">
				<div class="col-<?php echo $grid;?>-6">
					<div class="panel panel-info">
						<div class="panel-heading">ตรวจสอบผลการสอบห้องเรียน&nbsp;วิทยาศาสตร์&nbsp;สสวท.</div>
