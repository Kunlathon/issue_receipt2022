...
<head>
	...
	<title>ประกาศรายชื่อผู้มีสิทธิ์สอบ&nbsp;ห้องเรียน&nbsp;วิทยาศาสตร์&nbsp;สสวท.</title>
...
<script>
	$(document).ready(function (){
		$("#button_cilk").click(function(){
			...
			if(stu_id!=""){
				$.post("<?php echo base_url();?>/tools/code/oepn_ipst.php",{
					copy_stuID:stu_id
				},function (data){
					if(data !=""){
		...
		<div class="page-content">		
			<div class="row">
				<div class="col-<?php echo $grid;?>-12">
					<img src="<?php echo base_url();?>/tools/img/i-01-01.jpg" alt="Cinque Terre" usemap="#Map" class="img-thumbnail" style="width: 100%;" >
				</div>
			</div>
			<div class="row">
				<div class="col-<?php echo $grid;?>-6">
					<div class="panel panel-info">
						<div class="panel-heading">ตรวจสอบรายชื่อผู้มีสิทธิ์สอบห้องเรียน&nbsp;วิทยาศาสตร์&nbsp;สสวท.</div>
			...
			<div class="row">
				<div class="col-<?php echo $grid;?>-12">
					<center><button type="button" id="but_home" class="btn btn-default"><i class="icon-home position-left"></i>Home</button></center>
				</div>
			</div>	
